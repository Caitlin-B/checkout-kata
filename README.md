...
My attempt at a solution for the above kata.

Run `go run main.go` to output the total for the scanned items. To alter the items scanned amend `scannedItems` variable in `main.go`.
